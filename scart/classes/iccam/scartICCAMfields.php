...
class scartICCAMfields {
    ...
    public static function getCommercialityID($question,$record) {
        ...
        scartLog::logLine("D-scartICCAMfields; field=$question->name; answer=".self::$CommercialityIDMap[$answer].", ID=$ID ");
        return $ID;
    }
    ...
    public static function getPaymentMethodID($question,$record) {
        ...
        scartLog::logLine("D-scartICCAMfields; field=$question->name; answer=".self::$PaymentMethodIDMap[$answer].", ID=$ID ");
        return $ID;
    }
    ...
    public static function getContentType($question,$record) {
        ...
        scartLog::logLine("D-scartICCAMfields; field=$question->name; answer=".self::$ContentTypeMap[$answer].", ID=$ID ");
        return $ID;
    }
