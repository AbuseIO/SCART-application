...
/**
 * SCART ICCAM mapping class
 *
 * mapping from/to ICCAM API
 *
 */
...
class scartICCAMmapping {
        ...
        if (self::isActive()) {
            ...
            try {
                ...
                if (scartICCAM::login()) {
                    ...
                    if ($record->reference != '') {
                        $iccamdata['ReportID'] = scartICCAMfields::getICCAMreportID($record->reference);
    ...
    public static function alreadyImportedICCAMreportID($reportID) {
        ...
        $refReportID = scartICCAMfields::setICCAMreportID($reportID);
