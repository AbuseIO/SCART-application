...
return [
    ...
    'menu' => [
        ...
        'gradequestions' => 'Classify questions',
        'manualedit' => 'Manual editor',
    ...
    'button' => [
        'proxy_check' => 'Check proxy service',
        'classify_selected' => 'Classify selected',
        'set_ignore_close' => 'Set selected ignore & close',
        'add_work' => 'Add to my work',
        'police' => 'Police',
        'manual' => 'Manual',
        'illegal' => 'Illegal',
        'ignore' => 'Ignore',
        ...
        'edit' => 'Edit',
        'insert_rule' => 'Add rule',
        'process_rule' => 'Process rules',
        'list_view_title' => 'Set LIST view',
        'grid_view_title' => 'Set GRID view',
        ...
        'hide_group' => 'Hide...',
        'hide_ignore' => 'Ignore',
        'hide_ignore_not_illegal' => 'Ignore & not illegal',
        'hide_classified' => 'Classified',
        'hide_unhide_all' => 'Show all',
        'select_group' => 'Select...',
        'select_all' => 'All',
        'select_none' => 'None',
        'select_invers' => 'Invers selection',
        'select_not_classified' => 'Not classified',
        'bulk_group' => 'Bulk...',
        'bulk_set_illegal' => 'Set selected on illegal',
        'bulk_set_manual' => 'Set selected on manual',
        'bulk_set_ignore' => 'Set selected on ignore',
        ...
        'close_offline' => "Close (offline)",
        'import_urls' => "Import (CSV) urls",
        'continue_withmywork' => "Continue with my work",
        'recreate' => 'Recreate',
        'download_report' => "Download repport (CSV)",
        'merge_contacts' => "Merge geselecteerde",
        'check_validate' => "Check & validate selected addon(s)",
        'cont_checkonline' => "Check online",
        'first_police' => "First police",
        'close_selected' => "Close selected",
        'close_offline_selected' => "Close (offline) selected",
        'delete_selected' => "Delete selected",
        'analyze_input' => "Analyze input",
        'show_image' => "Show image",
        'export_ntd' => "Export NTD's",
    ...
    'flash' => [
        'setworker_warning' => "One or more of the selected are blocked by ':lockedby' - these are not updated",
        'setworker_info' => "Selected records are added to own work",
    ],

    // abuseio.scart::lang.confirm.
    'confirm' => [
        'ignore_close' => "Set selected ignore & closed?",
        'add_ownwork' => "Add selected to own work(load) ?",
        'done_confirm' => "Start check online process?",
        'unlock_input' => "Are you sure to unlock the url(s)? (can currently be processed by another person)",
        'merge_contacts' => "Merge the selected abusecontacts to one abusecontact? (first selected will be main abusecontact)",
        'delete_contacts' => "Delete the selected abusecontacts? (data of those contacts will be lost)",
        'close_selected' => "Set selected closed?",
        'close_offline_selected' => "Set selected closed (offline)?",
    ...
    'head' => [
        ...
        'INFO' => 'INFO',
        'EXTRA' => 'EXTRA',
        'edit_input' => 'Update input',
        'edit_note' => 'Updat memo',
        'classify' => 'Classify',
        'classify_selected' => 'Classify selected',
        'my_work' => 'Own work',
        'source_code' => 'Source',
    ...
    'text' => [
        'proxy_none' => 'no proxy service api set',
        'found_hash' => 'FOUND on HASH server',
    ...
    'backend' => [
        ...
        'form' => [
            ...
            'rule_not_allowed' => 'Not allowed, this domain has already an overrule',
            'url_not_allowed' => 'Not allowed, This format is not correct'
        ],
        'recordfinder' => [
