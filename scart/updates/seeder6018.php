...
class Seeder6018 extends Seeder
{
    public function run()
    {
        ...
        Db::table('abuseio_scart_iccam_api_field')->insert([
            ...
            ['iccam_field' => "virtualContentCategorization",'iccam_id' => "3",'iccam_name' => "No",'scart_field' => "IsVirtual",'scart_code' => "0",],
            ['iccam_field' => "virtualContentCategorization",'iccam_id' => "2",'iccam_name' => "Yes",'scart_field' => "IsVirtual",'scart_code' => "1",],
            ['iccam_field' => "userGeneratedContentCategorization",'iccam_id' => "3",'iccam_name' => "No",'scart_field' => "IsUserGC",'scart_code' => "0",],
            ['iccam_field' => "userGeneratedContentCategorization",'iccam_id' => "2",'iccam_name' => "Yes",'scart_field' => "IsUserGC",'scart_code' => "1",],
            ['iccam_field' => "childModelingCategorization",'iccam_id' => "3",'iccam_name' => "No",'scart_field' => "IsChildModeling",'scart_code' => "0",],
            ['iccam_field' => "childModelingCategorization",'iccam_id' => "2",'iccam_name' => "Yes",'scart_field' => "IsChildModeling",'scart_code' => "1",],
