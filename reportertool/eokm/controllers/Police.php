...
class Police extends ertController
{
    public $requiredPermissions = ['reportertool.eokm.police'];
    ...
    public function __construct() {
        parent::__construct();
        BackendMenu::setContext('ReporterTool.EOKM', 'Police');
    }
    ...
    public function listExtendQuery($query) {
        $query->where('status_code',ERT_STATUS_FIRST_POLICE)->orderBy('filenumber','ASC');
    }
